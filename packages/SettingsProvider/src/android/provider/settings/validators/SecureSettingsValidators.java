...
public class SecureSettingsValidators {
    ...
    static {
        ...
        VALIDATORS.put(Secure.ACCESSIBILITY_CAPTIONING_EASY_READER_ENABLED, BOOLEAN_VALIDATOR);
        ...
        VALIDATORS.put(Secure.DOZE_ALWAYS_ON_INACTIVITY_DETECTION, BOOLEAN_VALIDATOR);
        ...
        VALIDATORS.put(Secure.SCREENSAVER_ACTIVE_COMPONENT, NULLABLE_COMPONENT_NAME_VALIDATOR);
        ...
        VALIDATORS.put(Secure.NOTIFICATION_BUNDLES_ALWAYS_EXPAND, ANY_INTEGER_VALIDATOR);
        ...
        VALIDATORS.put(
                ...
                ACCESSIBILITY_SHORTCUT_TARGET_LIST_VALIDATOR);
        VALIDATORS.put(
                Secure.ACCESSIBILITY_TOP_ROW_KEY_TARGETS,
                ACCESSIBILITY_SHORTCUT_TARGET_LIST_VALIDATOR);
        VALIDATORS.put(
                Secure.ACCESSIBILITY_QUICK_ACCESS_TARGETS,
                ACCESSIBILITY_SHORTCUT_TARGET_LIST_VALIDATOR);
        ...
        VALIDATORS.put(Secure.FIRST_ON_DEVICE_MODELS_DOWNLOADED_TIME, NONE_NEGATIVE_LONG_VALIDATOR);
        VALIDATORS.put(Secure.CONTENT_SAFETY_SANDBOXED_IDLE_TIMEOUT_MS,
                NONE_NEGATIVE_LONG_VALIDATOR);
        VALIDATORS.put(Secure.CONTENT_SAFETY_IDLE_TIMEOUT_MS, NONE_NEGATIVE_LONG_VALIDATOR);
        VALIDATORS.put(Secure.CONTENT_SAFETY_SETTINGS_IDLE_TIMEOUT_MS,
                NONE_NEGATIVE_LONG_VALIDATOR);
        VALIDATORS.put(Secure.CONTENT_SAFETY_UNBIND_TIMEOUT_MS, ANY_LONG_VALIDATOR);
        VALIDATORS.put(Secure.CONTENT_SAFETY_SETTINGS_UNBIND_TIMEOUT_MS,
                ANY_LONG_VALIDATOR);
        ...
        VALIDATORS.put(Secure.MANDATORY_BIOMETRICS_REQUIREMENTS_SATISFIED,
                new InclusiveIntegerRangeValidator(0, 1));
        VALIDATORS.put(Secure.TRUSTED_LOCATIONS_COUNT, NON_NEGATIVE_INTEGER_VALIDATOR);
        ...
        VALIDATORS.put(Secure.IDENTITY_CHECK_NOTIFICATION_VIEW_DETAILS_CLICKED,
                new InclusiveIntegerRangeValidator(0, 1));
        VALIDATORS.put(Secure.IDENTITY_CHECK_WATCH_PROMO_CARD_SHOWN,
                new InclusiveIntegerRangeValidator(0, 1));
        ...
        VALIDATORS.put(Secure.PERSONAL_CONTEXT_ENABLED, BOOLEAN_VALIDATOR);
        VALIDATORS.put(Secure.PERSONAL_CONTEXT_MODE_ENABLED_DEFAULT, BOOLEAN_VALIDATOR);
        VALIDATORS.put(Secure.IS_WALLET_SERVICE_AVAILABLE, BOOLEAN_VALIDATOR);
        VALIDATORS.put(Secure.LIGHT_ANIMATION_FAVORITE_CALLS_ENABLED, BOOLEAN_VALIDATOR);
        VALIDATORS.put(Secure.IME_SWITCHER_BUTTON_IN_NAVBAR_ENABLED, BOOLEAN_VALIDATOR);
