...
public final class CardPagerAdapter extends PagerAdapter implements CardAdapter {
  ...
  public static class Companion {
    ...
    public final boolean useRecycledViewForNewTarget(
      ...
      if (!useRecycledViewForAction(newTarget.getBaseAction(), recycledTarget.getBaseAction())) {
        return false;
      }
      ...
      if (!useRecycledViewForActionsList(newTarget.getIconGrid(), recycledTarget.getIconGrid())) {
        return false;
      }
    ...
    if (targets.isEmpty()) {
      targets.add(
          new SmartspaceTarget.Builder(
                  ...
                  new ComponentName(root.getContext(), (Class<?>) CardPagerAdapter.class),
  ...
  public int getItemPosition(Object object) {
    ...
    if (currentTarget != null
        ...
        && currentTarget.getSmartspaceTargetId().equals(holder.target.getSmartspaceTargetId())) {
    ...
    if (target.getRemoteViews() != null) {
      ...
      BcSmartspaceRemoteViewsCard remoteViewsCard =
          enableCardRecycling.get()
              ? recycledRemoteViewsCards.removeReturnOld(BcSmartSpaceUtil.getFeatureType(target))
              : null;
      ...
      if (containsValidTemplateType) {
        ...
        BaseTemplateCard templateCard =
            enableCardRecycling.get()
                ? (BaseTemplateCard) recycledCards.removeReturnOld(target.getFeatureType())
                : null;
        if (templateCard == null
          ...
          templateCard =
              (BaseTemplateCard) inflater.inflate(layoutRes, (ViewGroup) container, false);
          templateCard.mUiSurface = uiSurface;
          if (templateCard.mDateView != null
              && TextUtils.equals(uiSurface, BcSmartspaceDataPlugin.UI_SURFACE_LOCK_SCREEN_AOD)) {
          ...
          Integer secondaryRes =
              templateTypeToSecondaryCardRes.get(target.getTemplateData().getTemplateType());
          if (templateData != null && secondaryRes != null) {
            BcSmartspaceCardSecondary secondaryCard =
                (BcSmartspaceCardSecondary)
                    inflater.inflate(secondaryRes, (ViewGroup) templateCard, false);
        ...
        BcSmartspaceCard legacyCard =
            enableCardRecycling.get()
                ? recycledLegacyCards.removeReturnOld(BcSmartSpaceUtil.getFeatureType(target))
                : null;
        if (legacyCard == null
            || (enableReducedCardRecycling.get()
          ...
          if (layoutRes == 0) {
            ...
            legacyCard =
                (BcSmartspaceCard) inflater.inflate(layoutRes, (ViewGroup) container, false);
            ...
            Integer secondaryRes =
                (Integer)
                    BcSmartSpaceUtil.FEATURE_TYPE_TO_SECONDARY_CARD_RESOURCE_MAP.get(featureType);
            if (secondaryRes != null) {
              legacyCard.setSecondaryCard(
                  (BcSmartspaceCardSecondary)
                      inflater.inflate(secondaryRes, (ViewGroup) legacyCard, false));
            }
          }
          bcSmartspaceCard = legacyCard;
        } else {
  ...
  public final void onBindViewHolder(ViewHolder holder) {
    ...
    BcSmartspaceCardLoggingInfo.Builder loggingInfoBuilder =
        new BcSmartspaceCardLoggingInfo.Builder()
            ...
            .setDisplaySurface(BcSmartSpaceUtil.getLoggingDisplaySurface(uiSurface, dozeAmount))
    ...
    BcSmartspaceCardLoggingInfo loggingInfo = new BcSmartspaceCardLoggingInfo(loggingInfoBuilder);
    if (target.getRemoteViews() != null) {
      if (holder.remoteViewsCard == null) {
  ...
  public final void setNonRemoteViewsHorizontalPadding(Integer padding) {
    ...
    for (int i = 0; i < recycledCards.size(); i++) {
      ...
      baseTemplateCard.setPaddingRelative(
          padding, baseTemplateCard.getPaddingTop(), padding, baseTemplateCard.getPaddingBottom());
    }
    for (int i = 0; i < recycledLegacyCards.size(); i++) {
      ...
      bcSmartspaceCard.setPaddingRelative(
          padding, bcSmartspaceCard.getPaddingTop(), padding, bcSmartspaceCard.getPaddingBottom());
    }
  }
  ...
  public void updateTargetVisibility() {
    ...
    boolean shouldUpdateLockscreen =
        smartspaceTargets != lockscreenTargets
            && (dozeAmount == 0f
                || (1f - dozeAmount >= 0.36f && transitioningTo == TransitionType.TO_LOCKSCREEN));
