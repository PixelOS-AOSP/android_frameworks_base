...
public class BaseTemplateCard extends ConstraintLayout implements SmartspaceCard {
  ...
  public final void bindData(
    ...
    if (mDateView == null) {
      ...
      TapAction tapAction =
          new TapAction.Builder(
                  (mTemplateData.getPrimaryItem() == null
                      ...
                      : mTemplateData.getPrimaryItem().getTapAction().getId().toString())
      ...
      BcSmartSpaceUtil.setOnClickListener(
          mDateView, mTarget, tapAction, eventNotifier, "SsBaseTemplateCard", loggingInfo, 0);
    }
    ...
    setUpTextView(
        ...
        true);
    setUpTextView(
        mSupplementalLineTextView, mTemplateData.getSupplementalLineItem(), eventNotifier, true);
      ...
      if (mDateView == null
        ...
        if (mTemplateData.getPrimaryItem().getTapAction().getIntent() != null
            && !mTemplateData
                ...
                .getTapAction()
                .getIntent()
                .filterEquals(mTemplateData.getSubtitleItem().getTapAction().getIntent())) {
          Log.d(
              "SsBaseTemplateCard",
          ...
          Log.d(
            ...
            || mTemplateData
                ...
                .getTapAction()
                .getPendingIntent()
                .equals(mTemplateData.getSubtitleItem().getTapAction().getPendingIntent())) {
          ...
          Log.d(
              ...
              "Primary item tapAction pendingIntent = "
                  + mTemplateData.getPrimaryItem().getTapAction().getPendingIntent());
          Log.d(
              "SsBaseTemplateCard",
              "Subtitle item tapAction pendingIntent = "
                  + mTemplateData.getSubtitleItem().getTapAction().getPendingIntent());
        }
      }
    }
    if (mSecondaryCardPane == null) {
  ...
  public final BcSmartspaceCardLoggingInfo getLoggingInfo() {
    ...
    BcSmartspaceCardLoggingInfo.Builder builder =
        new BcSmartspaceCardLoggingInfo.Builder()
            .setDisplaySurface(BcSmartSpaceUtil.getLoggingDisplaySurface(mUiSurface, mDozeAmount))
    ...
    if (mSubtitleSupplementalView != null) {
      ...
      if (mTemplateData != null) {
        updateTextViewIconTint(
            mSubtitleSupplementalView, shouldTint(mTemplateData.getSubtitleSupplementalItem()));
      }
    }
    updateZenColors();
  }
  ...
  public final void setSecondaryCard(BcSmartspaceCardSecondary secondaryCard) {
    ...
    if (secondaryCard != null) {
      ...
      params.setMarginStart(
          getResources()
              .getDimensionPixelSize(R.dimen.enhanced_smartspace_secondary_card_start_margin));
  ...
  public final void setUpTextView(
    ...
    if (mSubtitleAqiChipView == textView) {
      if (icon != null) {
        ...
        int pixel =
            bitmap != null
                ? icon.getIcon().getBitmap().getPixel(bitmap.getWidth() / 2, bitmap.getHeight() / 2)
                : 0;
        if (pixel == 0) {
    ...
    if (mLoggingInfo != null
      ...
      if (targetFeatureType != mLoggingInfo.mFeatureType) {
        for (int i = 0; i < mLoggingInfo.mSubcardInfo.mSubcards.size(); i++) {
          BcSmartspaceCardMetadataLoggingInfo subCard = mLoggingInfo.mSubcardInfo.mSubcards.get(i);
  ...
  public final void updateZenColors() {
    if (mSupplementalLineTextView != null) {
      ...
      if (BcSmartspaceCardLoggerUtil.containsValidTemplateType(mTemplateData)) {
        updateTextViewIconTint(
            mSupplementalLineTextView, shouldTint(mTemplateData.getSupplementalLineItem()));
      }
    }
  }
